...
const gameOver = () => {
  ...
  const timeTaken = (finishTime - startTime) / 1000;
   ...
   //Counting how many words are in the question
   const wordCount = questionText.split(" ").length;
   console.log(wordCount);
   let wordPerMinute = ((wordCount * 60)/ timeTaken.toFixed()).toFixed();
  ...
  resultModal.innerHTML = `
    ...
    <p>Your speed was <span class="bold green">${wordPerMinute}</span> WPM</p>
